declare module "Bitburner" {
  ...
  export interface GangGenInfo {
    ...
    /**
     * Whether territory warfare is engaged
     */
  ...
  export interface GangAscensionResult {
    str: number;
  }
  ...
  export interface GangMemberInfo {
    ...
    upgrades: (GangEquipment | GangAugmentations)[];
    /** Hacking stat */
    hacking: number;
  ...
  export interface Gang {
    ...
    getAscensionResult(memberName: string): GangAscensionResult;
  ...
  export interface BitBurner extends Singularity {
    ...
    kill(pid: number, host: Host): boolean;
